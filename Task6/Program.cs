...
namespace Task6
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            p1.Value = 1;
            using (DbDataReader mssqldr = mssql.ExecuteReader("select * from z where z > " + p1.PlaceHolder, p1))
            {
                p1.Value = 1;
            }
            ...
            p3.Value = 1;
            using (DbDataReader odbcdr = odbc.ExecuteReader("select * from z where z > " + p3.PlaceHolder, p3))
            {
            }
